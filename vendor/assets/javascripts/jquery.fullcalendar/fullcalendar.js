...
DayGrid.mixin({
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		iconHtml = '<span class="fc-type-icon"><i class="' + htmlEscape(event.icon) + '"></i></span>';
					...
					if (buttonName == 'title') {
						...
						if (buttonClick) {
							...
							if (overrideText) {
								...
								innerHtml = "<i class='fc-arrow " + themeIcon + "'></i>";
							}
							else if (normalIcon && !options.theme) {
								innerHtml = "<i class='fc-arrow " + normalIcon + "'></i>";
							}
							else {
